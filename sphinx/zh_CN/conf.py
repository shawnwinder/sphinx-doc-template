...
project = 'Proxima De Document'
copyright = '2022, Proxima Teams'
author = 'Proxima Teams'
...
htmlhelp_basename = 'Proxima-de-doc'
...
latex_documents = [
  (master_doc, 'Proxima.tex', u'Proxima Documentation',
...
man_pages = [
   (master_doc, 'Proxima', u'Proxima De Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Proxima', u'Proxima De Documentation',
   author, 'Proxima', 'One line description of project.',
   'Miscellaneous'),
]
...
def setup(app):
    ...
    #app.add_config_value('PROXIMA_SE_VERSION', '0.1.2', 'env')
